...
PROFILE_METRIC_META = {
    ...
    "Ground Duels /90": ("Defending", True, "Ground duel volume"),
    "Aerial Duels /90": ("Defending", True, "Aerial duel volume"),
    "Defensive Duels /90": ("Defending", True, "Total duel volume"),
    "Ground Duel Win %": ("Defending", True, "Ground duels"),
    "Aerial Duel Win %": ("Defending", True, "Aerial duels"),
    "Key Passes /90": ("Passing", True, "Shot assists"),
    "Long Passes (25m+) /90": ("Passing", True, "Long-pass volume"),
